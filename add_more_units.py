...
def update_package_size():
    """Opdaterer package_size for bruger 41967 til 100 enheder"""
    try:
        ...
        # Opdater package_size til 100 enheder
        cursor.execute('''
            UPDATE active_meters
            SET package_size = 100.0
            WHERE booking_id = %s
        ''', ('41967',))
        ...
        print("Pakkestørrelse er nu opdateret til 100 enheder")
